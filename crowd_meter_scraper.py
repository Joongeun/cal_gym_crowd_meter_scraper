...
SAVE_DIR = "/Users/clash/Documents/VSCode/Personal reminder cron jobs/.venv/code"  
MHTML_FILE = "/Users/clash/Documents/VSCode/Personal reminder cron jobs/.venv/code"
MHTML_FILE = os.path.join(SAVE_DIR, "page.mhtml")
CSV_FILE = os.path.join(SAVE_DIR, "crowd_meter_data.csv")
